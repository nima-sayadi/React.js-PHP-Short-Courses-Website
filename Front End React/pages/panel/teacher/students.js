...
class students extends Component {
    ...
    componentDidMount() {
        ...
        axios.get("http://localhost/api/teacher/course/students.php",config).then(response=>{
    ...
    render() { 
        if(this.state.loading == true){
            return <Loading title = "دانش آموزان" />
        }
        ...
        return (
            <div>
                <Head>
                    <title>دانش آموزان | خرد پرور</title>
                ...
                <div className={common.wrapper}>
                    <div className={common.container}>
                        ...
                        handleNav = {this.handleNavigation} type = "students" />
                    </div>
                    <Menu />
                </div>
            </div>
